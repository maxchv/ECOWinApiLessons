...
// Нестандартные панели инструментов
/*
    Для использования нестандартных изображений в панели инструментов необходимо:
    ...
    б) указать количество изображений при передаче сообщения TB_ADDBITMAP в аргументе wParam
        
        SendMessage(hToolbar, TB_ADDBITMAP, 6, (LPARAM)&tbAddBmp);

    в) Задать размер отдельного изображения панели инструментов в битмапе
