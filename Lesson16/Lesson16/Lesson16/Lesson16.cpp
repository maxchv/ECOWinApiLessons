...
typedef struct tagOFN {
    ...
    LPTSTR        lpstrFile;		// указатель на буфер, содержащий имя файла для  
	                                // инициализации текстового поля File Name диалога. 
									// После выбора файла и  закрытия диалога буфер будет 
									// содержать полный путь к выбранному файлу
...
•	OFN_OVERWRITEPROMPT - предписывает диалогу «Сохранить как» выводить окно 
