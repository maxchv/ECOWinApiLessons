// 03.UsingWindowInfo.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "03.UsingWindowInfo.h"
#include <iostream>
#include <sstream>
using namespace std;
#ifdef UNICODE
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MY03USINGWINDOWINFO, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY03USINGWINDOWINFO));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MY03USINGWINDOWINFO));
