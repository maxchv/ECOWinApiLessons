...
19)	Что такое статический элемент управления? Какие бывают типы статических элементов у
    правления?
...
void ex02()
{
	...
	*/
	...
	/*
	Если первый параметр вышерассмотренных функций имеет значение HWND_BROADCAST, 
	то  сообщение посылается всем окнам верхнего уровня, существующим в настоящий 
	момент в системе
	*/
}
