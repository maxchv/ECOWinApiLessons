...
/*
	...
	Примечание: Если список не нужен, то его необходимо уничтожить вызвав функцию ImageList_Destroy.
	...
	Возвращает дескриптор списка изображений ранее ассоциированного с элементом управление в случае
	успешного выполнения команыди или NULL в случае ошибки.
*/
