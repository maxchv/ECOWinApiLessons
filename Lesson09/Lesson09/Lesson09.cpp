...
4)	Какое уведомление от текстового поля приходит родительскому окну (диалогу) 
    при вводе текста?
5)	Какие сообщения отправляются текстовому полю ввода при копировании, вырезании и 
    удалении фрагмента текста?
6)	Какое сообщение необходимо отправить текстовому полю, чтобы получить границы выделения 
    текста?
